...
public class TestRegularValid extends RegularSetup {
	...
	public void testCanGetAffectedCoordinates() {
		...
		MoveCommand move = new RegularMove(g, c1, c2);
	...
	public void testGetAffectedCoordinatesIsEmptyIfInvalid() {
		MoveCommand move = new RegularMove(g, new Coordinate(-1, 6), new Coordinate(1, 5));
	...
	public void testMoveLegal() {
		...
		MoveCommand move = new RegularMove(g1, start, end);
	...
	public void testRabbitCanMoveForwards1() {
		MoveCommand move = new RegularMove(g, new Coordinate(0, 1), new Coordinate(0, 2));
	...
	public void testRabbitCanMoveForwards2() {
		g.incrementTurn();
		MoveCommand move = new RegularMove(g, new Coordinate(0, 6), new Coordinate(0, 5));
