...
public class TestPushInvalid extends PushSetup {
	...
	public void testNotEnoughMoves() {
		assertTrue(pushingGame.move(new RegularMove(pushingGame, new Coordinate(7, 1), new Coordinate(7, 2))));
		assertTrue(pushingGame.move(new RegularMove(pushingGame, new Coordinate(7, 2), new Coordinate(7, 3))));
		assertTrue(pushingGame.move(new RegularMove(pushingGame, new Coordinate(7, 3), new Coordinate(7, 4))));
