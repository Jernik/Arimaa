...
public class TestRegularInvalid extends RegularSetup {
	...
	public void testExecutingAnInvalidMoveReturnsTheOriginalBoard() {
		MoveCommand move = new RegularMove(g, new Coordinate(0, 0), new Coordinate(0, -1));
	...
	public void testCantMoveWith0MovesLeft()
		...
		field.setInt(g, 0);
		MoveCommand move = new RegularMove(this.g, new Coordinate(0, 1), new Coordinate(0, 2));
	...
	public void testMustMoveToDifferentCoordinate() {
		MoveCommand move = new RegularMove(g, new Coordinate(0, 1), new Coordinate(0, 1));
		testInvalidMove(g, move);
	}

	@Test
	public void testMustBeAdjacent() {
		MoveCommand move = new RegularMove(g, new Coordinate(0, 1), new Coordinate(0, 3));
		testInvalidMove(g, move);
	}

	@Test
	public void testCantMoveNothing() {
		MoveCommand move = new RegularMove(g, new Coordinate(0, 2), new Coordinate(0, 3));
		testInvalidMove(g, move);
	}

	@Test
	public void testCantMoveIntoOccupiedSpace() {
		MoveCommand move = new RegularMove(g, new Coordinate(1, 7), new Coordinate(1, 6));
		testInvalidMove(g, move);
	}

	@Test
	public void testCantMoveEnemyPiece() {
		MoveCommand move = new RegularMove(g, new Coordinate(7, 6), new Coordinate(7, 5));
		testInvalidMove(g, move);
	}
	...
	public void testRabbitCantMoveBackwards1() {
		...
		MoveCommand move = new RegularMove(g, new Coordinate(0, 2), new Coordinate(0, 1));
		testInvalidMove(g, move);
	}
	...
	public void testRabbitCantMoveBackwards2() {
		...
		MoveCommand move = new RegularMove(g, new Coordinate(0, 5), new Coordinate(0, 6));
		testInvalidMove(g, move);
	}
