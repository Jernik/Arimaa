...
public class TestGameHashCodeEquality {
	...
	public void setup() {
		this.g1 = new Game();
		this.g2 = new Game();
		this.g1.move(new RegularMove(this.g1, new Coordinate(0, 1), new Coordinate(0, 2), Owner.Player1));
		this.g2.move(new RegularMove(this.g2, new Coordinate(0, 1), new Coordinate(0, 2), Owner.Player1));
	}
	...
	public void testGameNotEqualIfDifferentMoves() {
		testHashCodeNotEquals(() -> {
			RegularMove move = new RegularMove(this.g1, new Coordinate(0, 2), new Coordinate(0, 3), Owner.Player1);
	...
	public void testGameNotEqualIfDifferentTurnCounter() {
		testHashCodeNotEquals(() -> {
			...
			// 2nd move
			move = new RegularMove(this.g1, new Coordinate(0, 2), new Coordinate(0, 3), Owner.Player1);
			this.g1.move(move);
			this.g1.getBoardState().movePiece(new Coordinate(0, 3), new Coordinate(0, 2));
			...
			// 4th move
			move = new RegularMove(this.g1, new Coordinate(0, 6), new Coordinate(0, 5), Owner.Player2);
			this.g1.move(move);
