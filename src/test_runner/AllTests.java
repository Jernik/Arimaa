...
@Suite.SuiteClasses({ AiSetup.class, TestAi.class, TestGenerateRandomMoveIsUniform.class,
		...
		TestTimePanel.class, TestUndo.class, TestRegularValid.class, TestRegularInvalid.class, TestPullInvalid.class, TestPullValid.class, TestPushValid.class, TestPushInvalid.class, TestPiece.class })
